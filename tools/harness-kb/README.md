...
pipx install git+https://github.com/rodrigorjsf/ai-study-library.git#subdirectory=tools/harness-kb
```
...
3. 404 = free. 200 = taken (need rename in pyproject.toml).                                                                                  
...
5. package-data = ["data/**/*"] glob bundles 11 MB data into wheel. Verify with unzip -l dist/*.whl | head -20.                              

6. Test upload first (TestPyPI)                                                                                                              
...
8. Or pip install twine && twine upload dist/*.                                                                                              
...
6. Or pip install twine && twine upload dist/*.
